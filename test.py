...
@register_tool(
    ...
    "Project the probability of a player going over/under/pushing a given stat line "
    "in the next game. Fits a count distribution (Negative Binomial, or Poisson when "
    "the data isn't overdispersed) to recent games and returns exact probabilities "
    "plus which model was used.",
    {
        "type": "object",
        "properties": {
            "player_name": {"type": "string", "description": "The player's name (first, last, or full)."},
